...
install:
	...
	@cat public/js/jquery.js public/js/knockout.js public/js/knockout.mapping.js public/js/bootstrap.js public/js/dates.js > public/js/minified.js

	@echo "Collection graph JS files"
	@cat public/js/raphael.min.js public/js/popup.raphael.js public/js/repo-graph.js >> public/js/minified.js
